...
# kubevirt.io/virt-observability-controller-bundle:$VERSION and kubevirt.io/virt-observability-controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= kubevirt.io/virt-observability-controller
...
rm -f $(1) || true ;\
env GOBIN=$(LOCALBIN) go install $${package} ;\
if [ ! -f $(1) ]; then \
	cp $$(go env GOBIN)/$(notdir $(1)) $(1) ;\
fi ;\
mv $(1) $(1)-$(3) ;\
} ;\
ln -sf $(1)-$(3) $(1)
